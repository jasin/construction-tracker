  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-else class="space-y-6">
          ...
          <div class="flex justify-between items-start">
            <div>
              ...
              <div class="mt-2 flex items-center gap-6 text-sm text-gray-600">
                <div v-if="currentProject.client" class="flex items-center gap-1">
            ...
            <div class="flex gap-2">
              <Button
                ...
                severity="secondary"
                outlined
                @click="openModal('projectSlideOver')"
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div v-if="priorityItems.length > 0" class="bg-amber-50 border border-amber-200 rounded-lg p-4">
        ...
        <!-- What's New Section -->
        <div v-if="todaysActivities.length > 0" class="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div class="flex items-start gap-3">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="space-y-4">
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
              ...
              <div class="p-4">
                <div v-if="recentDocuments.length === 0" class="text-center py-4 text-gray-500 text-sm">
